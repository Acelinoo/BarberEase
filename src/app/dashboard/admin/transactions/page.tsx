  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Semua transaksi yang sudah selesai</p>
      </div>
              ...
              <tbody className="divide-y border-b">
                {transactions.map((t: any) => (
                  <tr key={t.id} className="hover:bg-muted/50">
                    ...
                    <td className="px-6 py-4">{t.staff.name}</td>
                ...
                {transactions.length === 0 && (
                  <tr>
                    <td colSpan={5} className="px-6 py-8 text-center text-muted-foreground">Tidak ada transaksi</td>
                  </tr>
                )}
              </tbody>
            </table>
